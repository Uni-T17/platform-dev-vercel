      ...
      <div className="h-16 pt-3 ps-20 pe-20 flex justify-between items-center">
        <Link href={"/books"}>
          <div className="ms-10 flex items-center">
            <Image src="/logo.png" alt="BookEx logo" width={70} height={70} />
        ...
        <div>
          ...
          <Link
            className="font-semibold p-2 text-sm rounded-md hover:bg-[oklch(0.8_0.12_65)]"
            href={"/books/new"}
            onClick={requireAuth}
          >
            List Books
          ...
          {isAuth && (
            <Link
              className="ms-10 font-semibold text-sm p-2 rounded-md hover:bg-[oklch(0.8_0.12_65)]"
              href={"/exchanges"}
              onClick={requireAuth}
            >
              My Exchanges
        ...
        {isAuth && (
          <div className="flex justify-between items-center">
            <Link
              className="ms-10 flex gap-2 text-sm font-semibold p-2 rounded-md hover:bg-[oklch(0.8_0.12_65)]"
              href={"/credits"}
              onClick={requireAuth}
            >
